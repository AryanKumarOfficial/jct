        ...
        >
            ...
            <Body className="bg-gray-100 font-sans text-gray-800">
                <Container className="bg-white border border-gray-200 rounded-lg shadow-sm my-12 mx-auto p-8 max-w-xl">
                    ...
                    <Text className="text-base leading-7">
                        We've successfully received your submission to the JCT Journal. We appreciate your contribution to our publication. An account has been created for you to track the review process and manage your submissions.
                    </Text>
                    ...
                    <Section className="bg-light border border-cyan-200 rounded-md p-6 my-6">
                        <Heading as="h2" className="text-lg font-semibold text-gray-800 m-0">
                    ...
                    <Section className="text-center">
                        ...
                        <Text className="text-xs text-gray-500">
                            You are receiving this email because you made a submission to our journal.
                        </Text>
                    </Section>
                </Container>
            </Body>
