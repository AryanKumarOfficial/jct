...
export const NewEditorEmail = ({
    ...
    <Html>
        ...
        >
            <Head />
            <Preview>Welcome Aboard! Your JCT Journal Editor Account is Ready.</Preview>
            <Body className="bg-gray-50 font-sans text-gray-700">
                <Container className="bg-white border border-gray-200 rounded-lg shadow-sm my-12 mx-auto p-8 max-w-2xl">
                    ...
                    <Section className="text-center">
                        <Img src={logoUrl} width="120" alt="JCT Journal Logo" className="mx-auto" />
                        <Heading className="text-2xl font-semibold text-brand mt-6">
                            Welcome to the JCT Journal Editorial Team!
                        </Heading>
                    </Section>

                    <Text className="text-base leading-7 mt-6">
                        Dear {firstName},
                    </Text>
                    <Text className="text-base leading-7">
                        We are delighted to formally welcome you as an Editor for the <strong className="text-brand">JCT Journal System</strong>. Your expertise is a valuable addition to our team, and we are excited for the contributions you will make to uphold our journal's standards of excellence.
                    </Text>
                    <Text className="text-base leading-7">
                        Your editor account has been created. You can access your dashboard using the credentials below.
                    </Text>
                    ...
                    <Section className="bg-light border border-dashed border-cyan-300 rounded-md p-6 my-8">
                        ...
                        <Text className="text-base m-0">
                            ...
                            <code className="font-mono bg-cyan-100 text-cyan-800 px-2 py-1 rounded ml-2">{password}</code>
                        </Text>
                    </Section>
                    ...
                    <Section className="text-center">
                        <Text className="text-xs text-gray-500">
                            © {new Date().getFullYear()} JCT Journal System, Bhopal, MP, India. All rights reserved.
                        </Text>
                        <Text className="text-xs text-gray-500">
                            You received this email because you were invited to be an editor. If this was a mistake, please disregard this email.
                        </Text>
                    </Section>
                </Container>
            </Body>
