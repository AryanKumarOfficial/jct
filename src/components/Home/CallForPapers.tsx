  ...
  return (
    <section id="cfp" className="relative pt-14 pb-16">
      <div className="container max-w-screen-2xl mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-2 py-1 rounded-full bg-primary/20 text-primary text-[11px] font-semibold uppercase tracking-widest border border-primary/30">
            Call for Papers
          </div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight mt-3">
            Now accepting submissions for Volume 14, Issue 2 ({year})
          </h2>
