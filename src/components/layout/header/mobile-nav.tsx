    ...
    return (
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right"
                          className="w-full sm:w-[380px] p-0 border-l border-border/50 bg-background/95 backdrop-blur-2xl">
                ...
                <div className="flex flex-col h-full">
                        ...
                        >
                            {NAV_LINKS.map((link) => (
                                <motion.div key={link.href} variants={itemVariants}>
                                    ...
                                    >
                                        <div
                                            className="h-9 w-9 rounded-lg bg-background border border-border/50 flex items-center justify-center group-hover:border-primary/50 group-hover:text-primary transition-colors">
                    ...
                    <div className="p-6 bg-muted/20 border-t border-border/50">
                        <Link href="/submit" onClick={() => setIsOpen(false)}>
                            <Button size="lg"
                                    className="w-full bg-primary text-primary-foreground hover:bg-primary-hover font-bold shadow-lg shadow-primary/20">
                                Submit Manuscript
