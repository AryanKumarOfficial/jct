        ...
        <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="hidden sm:block">
                <Link href="/submit">
                    <Button
                        size="sm"
                        className="relative overflow-hidden h-10 px-6 bg-primary text-primary-foreground hover:bg-primary-hover font-semibold rounded-full shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-primary/40 group"
                    >
