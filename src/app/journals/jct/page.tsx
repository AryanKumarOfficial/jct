                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["AI & ML", "Cloud Computing", "Cyber Security", "IoT", "Data Science", "Blockchain"].map((tag) => (
                                        <Badge key={tag} variant="secondary"
                                               className="cursor-pointer hover:bg-primary/20 transition-colors font-normal">
                                            {tag}
                                        </Badge>
                                    ))}
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        {archive.papers.length > 0 ? (
                                            ...
                                            <div
                                                ...
                                                <p className="text-muted-foreground italic">No papers published in this
                                                    issue yet.</p>
                                            </div>
                                        )}
                                    </div>
                                ...
                                <CardContent className="flex flex-col items-center justify-center space-y-6">
                                    ...
                                    <div className="space-y-2 max-w-md mx-auto">
                                        ...
                                        <p className="text-muted-foreground text-base">
                                            The archives are currently being updated or no issues have been published
                                            yet.
