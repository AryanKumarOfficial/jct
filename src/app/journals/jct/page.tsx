...
import {ArrowRight, Award, BookOpen, Calendar, Download, FileText, Filter, Quote, Search, Users} from "lucide-react";
...
async function getArchives() {
    try {
        return await prisma.archive.findMany({
            ...
            include: {
                papers: {
                    // Optional: Only show papers that are actually published
                    where: {
                        paperStatuses: {
                            some: {
                                status: "PUBLISHED",
