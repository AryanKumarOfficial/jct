...
export const PaperRow = memo(function PaperRow({paper, editors, onRefresh}: {
    ...
    const getStatusBadge = () => {
        ...
        const style = styles[statusEnum as keyof typeof styles] || styles.DRAFT;
    ...
    return (
        <tr className="group border-b transition-colors hover:bg-muted/30 data-[state=selected]:bg-muted">
